 ...
 */
public class User {
	DatabaseConnection userConnectionInstance = new DatabaseConnection();
	...
	public boolean insertUser(String userID, String userFirstname, 
		...
		try {
			preparedStatement = userConnectionInstance.createConnection().prepareStatement(insertUserQuery);
	...
	public void setUserTable(JTable userTable) {
		...
		try {
			preparedStatement = userConnectionInstance.createConnection().prepareStatement(selectUserDetailsQuery);
	...
	int getCaseworkerCount() {
		...
		try {
			preparedStatement = userConnectionInstance.createConnection().prepareStatement(caseworkerCountQuery);
			resultSet = preparedStatement.executeQuery();
	...
	int getUserAutoID() {
		...
		try {
			preparedStatement = userConnectionInstance.createConnection().prepareStatement(getSequentialID);
			resultSet = preparedStatement.executeQuery();
	...
	public List setUserDetails(int userID) {
		...
		try {
			preparedStatement = userConnectionInstance.createConnection().prepareStatement(getUserDataQuery);
	...
	public boolean updateUserDetails(String userID, String userFirstname, 
		...
		String updateUserSQL = "UPDATE tbl_user " 
                        ...
                        + "WHERE userID = ?";
                try {
			preparedStatement = userConnectionInstance.createConnection().prepareStatement(updateUserSQL);
